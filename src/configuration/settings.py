...
class Settings:
    ...
    def set_option_to(self, field_name: str, field_value: Any) -> None:
        """Public method to set a specified setting to a supplied value"""
        self._config_data[field_name] = field_value

    def integrate_config(self, config_updates: dict) -> int:
    ...
    def export_config(self, filename: str) -> None:
        """Serialises and exports configuration settings for local storage"""
        self._context.export_config(filename, self._config_data)
